...
const Drinks: NextPage = () => {
	...
	const drinks = products.filter((val: any) => {
		return val;
	});
	...
	const getProducts = async () => {
		...
		const response = await fetch(
			`https://online-menu-pedro-fagundes.herokuapp.com/products/drinks-${i18n?.language}`
		);
